...
export default function RegisterPage() {
  ...
  const registerAction = useAppStore((s) => s.actions.register);
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center">
      <div className="w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-zinc-600">
          Register with email or use Google.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          <div>
            <label htmlFor="register-email" className="block text-xs font-medium text-zinc-700">
              Email
            </label>
            <input
              id="register-email"
          ...
          <div>
            <label htmlFor="register-password" className="block text-xs font-medium text-zinc-700">
              Password
            </label>
            <input
          ...
          <div>
            <label htmlFor="register-confirm" className="block text-xs font-medium text-zinc-700">
              Confirm password
            </label>
            <input
              id="register-confirm"
